...
\chead{}
\rhead{}
\lfoot{ENT 432 (Fall 2020) - Penn State}
\cfoot{}
\rfoot{\thepage}
...
\begin{figure}[ht!]
    ...
    \begin{subfigure}[ht!]{0.38\textwidth}
        ...
        \caption{Wings \citep[composed from][Plate C]{bhl73500}}%usehttp://biodiversitylibrary.org/page/22703602?
        \label{fig:pyraloid1}
    \end{subfigure}
    \hfill %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc. 
      %(or a blank line to force the subfigure onto a new line)
...
\begin{figure}[ht!]
    ...
    \qquad
    \begin{subfigure}[ht!]{0.37\textwidth}
        \includegraphics[width=\textwidth]{NoctuidHabitus}
...
\begin{figure}[ht!]
    ...
    \hfill 
    \begin{subfigure}[ht!]{0.4\textwidth}
        \includegraphics[width=\textwidth]{HydropsychidLarva}%https://archive.org/stream/bulletin2319441945illi/#page/81/mode/1up
